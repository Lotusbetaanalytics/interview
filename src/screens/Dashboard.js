...
const Dashboard = () => {
  ...
  return (
    <>
      <Sidebar />
      <Navbar title='Dashboard' name={`Hello ${user && user.firstName}`} />

      <div className='container'>
        <div className='feed'>
          <div className='feed_user'>
            <h2 className='feed_title'>{`Hello ${user && user.firstName}`} 👍👍🥇</h2>
            <br></br>
            <br></br>
        ...
        <div className='cardGrid'>
          <Infobox
            ...
            color='Green'
          />
          <Infobox title='Admin' count='7' Icon={RiAdminFill} color='#7070db' />
          <Infobox

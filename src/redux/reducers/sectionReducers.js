import {CREATE_SECTION_FAIL,CREATE_SECTION_SUCCESS,
    CREATE_SECTION_REQUEST,
    CREATE_SECTION_RESET,GET_SECTION_FAIL,GET_SECTION_SUCCESS,
    GET_SECTION_REQUEST,
GET_SECTION_BYID_REQUEST,GET_SECTION_BYID_FAIL,GET_SECTION_BYID_SUCCESS
    ...
    export const getSectionReducer = (state = {section:[]}, action) => {
        switch (action.type) {
          ...
          case GET_SECTION_SUCCESS:
            return { loading: false, success: true, section:action.payload.data}
    ...
    export const getSectionByIdReducer = (state = {sections:[]}, action) => {
        switch (action.type) {
          ...
          case GET_SECTION_BYID_SUCCESS:
            return { loading: false, success: true, sections:action.payload.data}

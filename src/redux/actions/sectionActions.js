...
import {CREATE_SECTION_FAIL,
    CREATE_SECTION_SUCCESS,
    CREATE_SECTION_REQUEST,GET_SECTION_FAIL,GET_SECTION_SUCCESS,
    GET_SECTION_REQUEST,
GET_SECTION_BYID_SUCCESS,GET_SECTION_BYID_REQUEST,GET_SECTION_BYID_FAIL
} from '../constants/sectionConstants'

export const createSection =(title, timer,instruction,test) => async (dispatch, getState) => {
    try {
